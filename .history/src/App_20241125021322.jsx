...
function App() {
  ...
  function applyFiltersAndSorting() {
    ...
    // Apply sorting (only one sort can be active at a time)
  ...
  function handleContinentChange(e) {
    ...
    setSubregion('Choose region'); // Reset subregion when continent changes
  }

  function handleSubRegionChange(e) {
    setSubregion(e.target.value);
    setContinent('All'); // Reset continent when subregion changes
  }
  ...
  return (
    <div>
      ...
      {isLoading ? (
        ...
        <p>Oops sorry! Error in fetching data</p>
      ) : (
